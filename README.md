...
[Dagger 2](https://github.com/google/dagger) (2.11-2.15) with the 
...
the following larger project for a more real-world example on how to apply Dagger Android (2.11-2.15), 
...
- Dagger 2: *2.11, 2.12, 2.13, 2.14, 2.15*
- Butterknife: *8.7, 8.8*
...
1. Creating a project, from scratch, using the new Dagger.Android (2.11-2.15) dependency injection 
